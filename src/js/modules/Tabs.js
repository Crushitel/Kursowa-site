...
class Tabs {
  ...
  direction = null;
  errors = {
    selectorNotExist: 'Селектор data-tabs не існує',
    duplicateTabs: 'Кількість елементів із одинаковим data-tabs більше одного',
    mismatch: 'Кількість кнопок и кількість панелей не збігається',
  };
